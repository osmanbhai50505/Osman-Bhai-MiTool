...
# 🔄 লিংকগুলো master থেকে বদলে main ব্রাঞ্চে সেট করা হলো
...
# 🔄 এখানেও master থেকে main করা হয়েছে CHANGELOG এর জন্য
curl -s -L https://raw.githubusercontent.com/osmanbhai50505/Osman-Bhai-MiTool/main/CHANGELOG.md | tac | awk -v I="$I" -v N="$N" '/^#/{exit} {print I $0 N}' | tac

echo -e "${G}✔ Installation completed successfully${N}\n"

echo -e "Welcome Owner: ${G}OSMAN BHAI${N}"
